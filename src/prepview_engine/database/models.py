...
class FinalReport(Base):
    ...
    nlp_aggregate = Column(JSON, nullable=False)  # Stores WPM, Fillers, Weakest Link ID
    cv_aggregate = Column(JSON, nullable=False)   # Stores Eye Contact, CV Score
    
    # ✅ The Generated Text
    ai_feedback = Column(Text, nullable=False)    # The Markdown report from LLM
